...
absen = [
    ...
    "**Hadir Sayang** 😳",
    "**Hadir Bro vortax** 😁",
    "**Maaf ka habis nemenin ka vortax** 🥺",
    "**Maaf ka habis disuruh Tuan vortax** 🥺🙏🏻",
    "**Hadir vortax Sayang** 😘",
    "**Hadir vortax Akuuuuhhh** ☺️",
    "**Hadir vortax brother Aku** 🥰",
]

kazucakep = [
    "**𝙄𝙮𝙖 vortax 𝙂𝙖𝙣𝙩𝙚𝙣𝙜 𝘽𝙖𝙣𝙜𝙚𝙩** 😍",
    "**𝙂𝙖𝙣𝙩𝙚𝙣𝙜𝙣𝙮𝙖 𝙂𝙖𝙠 𝘼𝙙𝙖 𝙇𝙖𝙬𝙖𝙣** 😚",
    "**𝙆𝙖𝙢𝙪 𝙂𝙖𝙣𝙩𝙚𝙣𝙜𝙣𝙮𝙖 𝘼𝙠𝙪 𝙆𝙖𝙣 vort** 😍",
    "**𝙄𝙮𝙖𝙖 𝙜𝙖𝙙𝙖 𝙖𝙙𝙖 𝙨𝙖𝙞𝙣𝙜** 😎",
